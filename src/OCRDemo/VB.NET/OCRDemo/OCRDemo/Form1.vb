...
Public Class Form1
    ...
    Private Sub OCR(ByVal isOcrOnRectangleArea As Boolean)
        ...
        If (m_bSamplesExist) Then
            languageFolder = m_strCurrentDirectory + "Redistributable\"
        End If
        ...
        Else
            sbytes = Me.dynamicDotNetTwain1.OCR(dynamicDotNetTwain1.CurrentImageIndexInBuffer, Integer.Parse(tbxLeft.Text), Integer.Parse(tbxTop.Text), Integer.Parse(tbxRight.Text), Integer.Parse(tbxButtom.Text))
        End If
