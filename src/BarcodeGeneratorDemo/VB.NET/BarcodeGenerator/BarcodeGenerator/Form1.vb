...
Public Class Form1
    ...
    Private Sub btnLoadImage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadImage.Click
        Try
            ...
            openfiledlg.Filter = "All Support Files|*.JPG;*.JPEG;*.JPE;*.JFIF;*.BMP;*.PNG;*.TIF;*.TIFF;*.PDF|JPEG|*.JPG;*.JPEG;*.JPE;*.Jfif|BMP|*.BMP|PNG|*.PNG|TIFF|*.TIF;*.TIFF|PDF|*.PDF"
        ...
        Try
            If (Me.DynamicDotNetTwain1.HowManyImagesInBuffer > 0) Then
                ...
                If (txtBarcodeContent.Text <> "" And txtBarcodeLocationX.Text <> "" And txtBarcodeLocationY.Text <> "" And txtBarcodeScale.Text <> "") Then
                    DynamicDotNetTwain1.AddBarcode(DynamicDotNetTwain1.CurrentImageIndexInBuffer, barcodeformat, txtBarcodeContent.Text, txtHumanReadableTxt.Text, CInt(txtBarcodeLocationX.Text), CInt(txtBarcodeLocationX.Text), CDbl(txtBarcodeScale.Text))
                Else
